    ...
    <footer className="bg-slate-900 text-slate-400 pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-slate-800/80 pt-8 pb-4 flex flex-wrap justify-between items-center gap-6">
          ...
          {/* Consultant Portals: BCM NAV & ISO-X (Rata Kanan) */}
          <div className="flex flex-wrap items-center gap-3 ml-auto">
            <button
              type="button"
              onClick={() => setIsBcmModalOpen(true)}
              className="px-2.5 py-1 rounded border border-cyan-500/60 bg-cyan-950/40 text-cyan-400 font-bold hover:bg-cyan-900/60 hover:border-cyan-400 hover:text-cyan-300 transition-all flex items-center gap-1.5 cursor-pointer shadow-sm shadow-cyan-500/20 group text-[10px] tracking-wider uppercase"
